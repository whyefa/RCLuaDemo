...
demoLabel.text("点击屏幕一次执行一次测试Demo")
...
demoArray = {
	...
	function (  )
		...
		date3 = Date("2014-12-02 12:03:40")
		print(date2)
		print(date3)
		if date3 == date2 then 
			print("date3 == date2")
	...
	function (  )
		...
		if transform1.isIdentity() then 
			print("transform1.isIdentity == true")
		then
			print("transform1.isIdentity == false")
		end
	...
	function (  )
		...
		transform3.transform3D(20, 20, 20)
